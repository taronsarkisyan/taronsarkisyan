...
Hi, Im CEO of Arnelify®.

## 🤟🏻 Free open-source tools for everyone
### 📦 Arnelify Mail v0.5.0
...
### 📦 Arnelify React Native v0.5.1
GitHub: https://github.com/arnelify/arnelify-react-native<br/>
NPM: https://npmjs.com/arnelify-react-native
...
### 📦 Arnelify POD for C++ v0.5.2
GitHub: https://github.com/arnelify/arnelify-pod-cpp

A BackEnd-Framework that allows companies and developers to create pods with microservices written in C++.

* Arnelify Broker written in C++
https://github.com/arnelify/arnelify-pod-cpp/tree/main/src/core/broker

* Arnelify Router written in C++
https://github.com/arnelify/arnelify-pod-cpp/tree/main/src/core/router

* Arnelify Server written in C++
https://github.com/arnelify/arnelify-pod-cpp/tree/main/src/core/boot/boost

### 📦 Arnelify POD for Python v0.5.2
🚧 Under development<br/>
GitHub: https://github.com/arnelify/arnelify-pod-python

A BackEnd-Framework that allows companies and developers to create pods with microservices written in Python.

### 📦 Arnelify POD for Node v0.5.1
GitHub: https://github.com/arnelify/arnelify-pod-node<br/>
NPM: https://npmjs.com/arnelify-pod

A BackEnd-Framework that allows companies and developers to create pods with microservices written in Node.

### 📦 Arnelify POD for PHP v0.5.1
🚧 Under development<br/>
